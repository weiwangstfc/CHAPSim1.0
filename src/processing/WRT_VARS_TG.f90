...
SUBROUTINE WRT_INSTANT_VARS_TG
    ...
    DO IVEL = 1, NDV + 1
        ...
        CALL MPI_FILE_OPEN(MPI_COMM_WORLD,WRT_RST_FNM_TG(IVEL), MPI_MODE_WRONLY + MPI_MODE_CREATE, MPI_INFO_NULL, MYFILE, IERR)
...
SUBROUTINE WRT_AVERAGE_VARS_TG
    ...
    CALL MPI_TYPE_COMMIT(NEWTYPE, IERR)
    CALL MPI_FILE_OPEN(MPI_COMM_WORLD,WRT_AVE_FNM_tg, MPI_MODE_WRONLY + MPI_MODE_CREATE, MPI_INFO_NULL, MYFILE, IERR)
